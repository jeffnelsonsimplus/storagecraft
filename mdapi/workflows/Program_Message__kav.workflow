...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>Approval_Email_PM</fullName>
        <ccEmails>nephi.printy@storagecraft.com</ccEmails>
        <description>Approval Email PM</description>
        ...
        <template>Support_Automatic/Article_Response_PM</template>
    </alerts>
    <alerts>
        <fullName>Rejection_Email_PM</fullName>
        <ccEmails>nephi.printy@storagecraft.com</ccEmails>
        <description>Rejection Email PM</description>
        <protected>false</protected>
        <recipients>
            <type>creator</type>
        </recipients>
    ...
    <fieldUpdates>
        <fullName>PM_Approval_Approved</fullName>
        <field>Approval_Status__c</field>
        <literalValue>Approved</literalValue>
        <name>PM Approval Approved</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>PM_Approval_Recalled</fullName>
        <field>Approval_Status__c</field>
        <literalValue>Pending</literalValue>
        <name>PM Approval Recalled</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>PM_Approval_Rejected</fullName>
        <field>Approval_Status__c</field>
        <literalValue>Rejected</literalValue>
        <name>PM Approval Rejected</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>PM_Approval_Submitted</fullName>
        <field>Approval_Status__c</field>
        <literalValue>Submitted</literalValue>
        <name>PM Approval Submitted</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <knowledgePublishes>
        <fullName>Publish_New_PM</fullName>
        <action>PublishAsNew</action>
        <label>Publish New PM</label>

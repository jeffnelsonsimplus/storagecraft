...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <customApplicationComponents>
        ...
        <customApplicationComponent>Emergencies</customApplicationComponent>
        <customApplicationComponent>PartnerCases</customApplicationComponent>
        <customApplicationComponent>Console.BuiltInComponent.knowledgeOne</customApplicationComponent>
    </customApplicationComponents>
    <defaultLandingTab>standard-home</defaultLandingTab>
    <description>StorageCraft Service Cloud - Case Feed Action View - With Partner Cases Component - List Pinned</description>
    ...
    <label>Service Cloud Partner Pinned</label>
    <listPlacement>
